...
def login():
    if request.method == 'POST':
        ...
        if user and check_password_hash(user['password_hash'], password):
            ...
            session['otp_verified'] = False # Require OTP verification
...
def verify_otp():
    if request.method == 'POST':
        ...
        if 'otp' in session and session['otp'] == user_otp:
            ...
            session.pop('otp', None) # Remove OTP after use
...
def send_otp():
    ...
    # --- OTP SIMULATION ---
    # In a real app, you would use an SMS API here.
    # For this project, we print it to the console.
    print("\n" + "="*50)
